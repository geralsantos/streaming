...
<v-app>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/mantenimiento/perfil/" class="btn btn-default btn-flat">Perfíl</a>
                </div>
                <div class="pull-right">
                  <a href="{{ url('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">Cerrar Sesión</a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="pull-left image">
        ...
        <div class="pull-left info" style="background-color:#353f4f !important">
          <p>{{ucwords(auth()->user()->usuario)}}</p>
      ...
      <ul class="sidebar-menu" data-widget="tree" style="padding-left:0px !important;">
  ...
  <div class="content-wrapper" style="overflow-y:auto !important;" >
...
<!-- ./wrapper -->
<script>
        //$('.v-skeleton-loader__list-item-three-line').css('background-color','#353f4f');
