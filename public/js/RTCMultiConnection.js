...
/***/ "./resources/js/rtc/RTCMultiConnection.js":
/*!************************************************!*\
  !*** ./resources/js/rtc/RTCMultiConnection.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, process) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; // Last time updated: 2019-06-15 4:26:11 PM UTC
...
var RTCMultiConnection = function RTCMultiConnection(roomid, forceOptions) {
  ...
  function MultiPeers(connection) {
    ...
    connection.peers = {
      ...
      getAllParticipants: function getAllParticipants(sender) {
        var allPeers = [];
      ...
      forEach: function forEach(callbcak) {
        this.getAllParticipants().forEach(function (participant) {
          callbcak(connection.peers[participant]);
        });
      },
      send: function send(data, remoteUserId) {
        var that = this;
    ...
    this.getLocalConfig = function (remoteSdp, remoteUserId, userPreferences) {
      ...
      return {
        ...
        onLocalSdp: function onLocalSdp(localSdp) {
          self.onNegotiationNeeded(localSdp, remoteUserId);
        },
        onLocalCandidate: function onLocalCandidate(localCandidate) {
        ...
        remoteSdp: remoteSdp,
        onDataChannelMessage: function onDataChannelMessage(message) {
        ...
        onDataChannelOpened: function onDataChannelOpened(channel) {
        ...
        onPeerStateChanged: function onPeerStateChanged(states) {
  ...
  (function () {
    var browserFakeUserAgent = 'Fake/5.0 (FakeOS) AppleWebKit/123 (KHTML, like Gecko) Fake/12.3.4567.89 Fake/123.45';
    var isNodejs = (typeof process === "undefined" ? "undefined" : _typeof(process)) === 'object' && _typeof(process.versions) === 'object' && process.versions.node &&
    /*node-process*/
    !process.browser;
    ...
    var isNodeWebkit = (typeof process === "undefined" ? "undefined" : _typeof(process)) === 'object' && _typeof(process.versions) === 'object' && process.versions['node-webkit']; // --------- Detect if system supports WebRTC 1.0 or WebRTC 1.1.
  ...
  function setHarkEvents(connection, streamEvent) {
    ...
    hark(streamEvent.stream, {
      ...
      onvolumechange: function onvolumechange(volume, threshold) {
  ...
  window.currentUserMediaRequest = {
    ...
    mutex: false,
    queueRequests: [],
    remove: function remove(idInstance) {
      this.mutex = false;
  ...
  function getUserMediaHandler(options) {
    ...
    if (currentUserMediaRequest.streams[idInstance]) {
      ...
      if (typeof navigator.mediaDevices === 'undefined') {
        ...
        var getUserMediaSuccess = function getUserMediaSuccess() {};

        var getUserMediaFailure = function getUserMediaFailure() {};

        var getUserMediaStream, getUserMediaError;
        navigator.mediaDevices = {
          getUserMedia: function getUserMedia(hints) {
  ...
  var StreamsHandler = function () {
    ...
    return {
      ...
      onSyncNeeded: function onSyncNeeded(streamid, action, type) {}
    };
  ...
  var TranslationHandler = function () {
    function handle(connection) {
      ...
      connection.Translator = {
        TranslateText: function TranslateText(text, callback) {
        ...
        getListOfLanguages: function getListOfLanguages(callback) {
  ...
  (function (connection) {
    ...
    function joinRoom(connectionDescription, cb) {
      connection.socket.emit('join-room', {
        ...
        extra: connection.extra,
        password: typeof connection.password !== 'undefined' && _typeof(connection.password) !== 'object' ? connection.password : ''
        ...
        if (isRoomJoined === false) {
          if (connection.enableLogs) {
            //  app.geral();
            var swal = self_.$store.getters.getSwal;
    ...
    connection.invokeGetUserMedia = function (localMediaConstraints, callback, session) {
      ...
      getUserMediaHandler({
        onGettingLocalMedia: function onGettingLocalMedia(stream) {
        ...
        onLocalMediaError: function onLocalMediaError(error, constraints) {
    ...
    connection.streamEvents = {
      selectFirst: function selectFirst(options) {
...
/***/ 2:
/*!******************************************************!*\
  !*** multi ./resources/js/rtc/RTCMultiConnection.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\xampp\htdocs\streaming\resources\js\rtc\RTCMultiConnection.js */"./resources/js/rtc/RTCMultiConnection.js");
