...
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; //window.Vue = require('vue');
...
Vue.use(vee_validate__WEBPACK_IMPORTED_MODULE_1__, {
      ...
      dictionary: {
        custom: {
          usuario: {
            ...
            max: 'El nombre de usuario debe ser menor a 50 caracteres' // custom messages
          ...
          contrasena: {
            ...
            max: 'La contraseña debe ser menor a 50 caracteres' // custom messages
  ...
  methods: {
    login: function login() {
      ...
      if (!this.errors.any()) {
        ...
        axios.post('loginVerificar', valores).then(function (response) {
          console.log(response);
          var data = response.data;

          if (data.success === true) {
            //location.href='dashboard';
            document.getElementById('form-login').submit(); //return false;
          } else {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('', 'Ha ocurrido un error: ' + errors, 'danger');
          _this.disableBtn = false;
        })["finally"](function () {
          this.disableBtn = false; //self.btnImportarDisabled=!self.btnImportarDisabled;
        });
      }
    }
  }
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  state: {
    count: 10,
    sweetAlertBlocked: {},
    swal: sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a,
    dialogSimple: {
      bodycard: '',
      buttons: '',
      dialog: false,
  ...
  mutations: {
    openSweetAlertBlocked: function openSweetAlertBlocked(state, data) {
    ...
    openDialogSimple: function openDialogSimple(state, data) {
    ...
    openDialogSimple2: function openDialogSimple2(state, data) {
    ...
    openDialogItems: function openDialogItems(state, data) {
      //no se utiliza
      state.dialogItems.dialog = data.response;
    },
    setProyecto: function setProyecto(state, data) {
      console.log(data);
      state.presupuesto.proyecto = data;
    }
  },
  getters: {
    getBodyCard: function getBodyCard(state) {
      //no se utiliza
      return state.dialogSimple.bodycard;
    },
    getSwal: function getSwal(state) {
      return state.swal;
    },
    getToastDefault: function getToastDefault(state) {
    ...
    getProyecto: function getProyecto(state) {
      return state.presupuesto.proyecto;
    }
  },
  actions: {
    setProyecto: function setProyecto(context, data) {
